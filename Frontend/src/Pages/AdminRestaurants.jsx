                  ...
                  {filteredRestaurants.length === 0 ? (
                    ...
                    filteredRestaurants.map((restaurant) => (
                      <tr key={restaurant._id} className="border-b hover:bg-gray-50">
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-4">
                            <img
                              ...
                              onError={(e) => (e.target.src = "https://picsum.photos/id/870/600/400")}
                            />
                            <div>
                        ...
                        <td className="px-6 py-5 text-gray-700">{restaurant.cuisine}</td>
                        <td className="px-6 py-5 text-gray-600">{restaurant.location}</td>
